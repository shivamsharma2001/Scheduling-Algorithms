...
<center>
<?php
$bt=$_POST["bt"]; // Storing burst time of every process in an array name bt
$tq=$_POST["tq"]; // Storing time quantum in an variable name tq
$n=count($bt);
$wt[0]=0;
$avg=0;
// Storing process id of each process
for($i=0;$i<$n;$i++)
{
   $psnam[$i]=$i+1;
}
